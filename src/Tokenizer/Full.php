...
final class Full extends AbstractTokenExtractor
{
    ...
    private static $expressionTypeMap = [
        ...
        '/(?<lexeme>(?:(?<domain>(?:[a-zA-Z0-9_\-.\[\]\*%][a-zA-Z0-9_\-.\[\]\*%]*|\'[^\']+\')):)?(?<delimiter>\())/Au'
        ...
        => Tokenizer::TOKEN_TERM,
        '/(?<lexeme>(?:(?<domain>(?:[a-zA-Z0-9_\-.\[\]\*%][a-zA-Z0-9_\-.\[\]\*%]*|\'[^\']+\')):)?(?<quote>(?<!\\\\)["])' .
        '(?<phrase>.*?)(?:(?<!\\\\)(?P=quote))(?:(?<marker>(?<!\\\\)\#)(?<flags>[a-zA-Z0-9_][a-zA-Z0-9_\-.]*))?)/Aus'
        => Tokenizer::TOKEN_TERM,
        '/(?<lexeme>(?:(?<domain>(?:[a-zA-Z0-9_\-.\[\]\*%][a-zA-Z0-9_\-.\[\]\*%]*|\'[^\']+\')):)?(?<rangeStartSymbol>[\[\{])' .
        ...
        => Tokenizer::TOKEN_TERM,
        '/(?<lexeme>(?:(?<domain>(?:[a-zA-Z0-9_\-.\[\]\*%][a-zA-Z0-9_\-.\[\]\*%]*|\'[^\']+\')):)?' .
        '(?<word>(?:\\\\\\\\|\\\\ |\\\\\(|\\\\\)|\\\\"|[^"()\s])+?))' .
